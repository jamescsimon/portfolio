    ...
    blue: {
        ...
        planets: [
            ...
            },
            {
                ...
                overview: "As Founder and Lead Designer, I lead the design team in gamifying a CBT mobile app in Unity with backend database for user telemetry tracking for therapy progress. Advised by educational psychologist Dr. Eun Park and professor of psychology Dr. Santiago Morales along facult at USC's School of Cinematic Arts, I will be both leading and collaborating with fellow students at USC and other universities among 6 teams in weekly sprints. I authored a comprehensive game design document covering game mechanics, user experience, and therapeutic objectives. I developed the Unity prototype in C#, implementing touch controls, animation state machines, branching dialogue trees, and save/load functionality with encrypted data serialization to create an engaging therapeutic experience. We plan on adding a breadth of accessibility features and conducting comprehensive QA testing including functional, usability, and user acceptance testing with target users.",
                projectDesc: "A mobile game first developed from a Sloan Grant games pitch that aimed to teach children anxiety coping mechanisms. It follows a  psychologist guiding feline clientele through cognitive behaviour therapies with hopes to empower kids to utilize them to conquer their own anxieties.",
