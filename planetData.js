    ...
    blue: {
        ...
        planets: [
            ...
            },
            {
                ...
                skills: ["Accessibility", "Backend Development", "C#", "CBT", "Cloud Integration", "Database Design", "Design Patterns", "Documentation", "Frontend Development", "Game Design/Development", "Healthcare Technology", "iOS Mobile App Development", "Leadership", "Mobile Development", "Performance Optimization", "Project Management", "Psychology", "Quality Assurance & Data Analysis", "QA", "Software Architecture", "Software Testing", "Team Collaboration/Communication", "Team Management", "Technical Writing/Documentation", "UI/UX Design", "Unity", "User Testing"],
                size: 4.3,
                position: 210,
                texture: './images/venus.jpg',
    ...
    pink: {
        ...
        planets: [
            ...
            },
            {
                ...
                link: null,
                overview: "As Fellowship/Contract Contributor at OpenAI (contract work through Handshake), I collaborated on user intent recognition for image generation prompts (Project Spectra), identifying limitations in transfer learning approaches and proposing alternatives. I designed intuitive, on-brand architecture and user interaction pipeline diagrams while spearheading the synthesis of user telemetry to identify behavioral patterns and bottlenecks. I automated failure prediction using Python ML libraries (scikit-learn, pandas), predicted user failure rates, and visualized key trends to inform design decisions. I presented data-driven UX recommendations to cross-functional team leads and iterated on frequent demos integrating LLM/NLP models for user feedback analysis. I optimized frontend UI for accessibility, responsiveness, and professional polish, led quantified QA testing cycles with actionable usability feedback, improved data parsing efficiency in both space and time complexity, and developed JavaScript unit tests to ensure consistent testing. I curated datasets of polished metadata to support context-aware image generation, designed scalable quality control frameworks to ensure dataset integrity, diagnosed and resolved scalability issues in published internal tools, facilitated cross-team alignment through compromise-driven conflict resolution, implemented data versioning protocols for reproducible ML experimentation, detected and isolated contaminated data batches to maintain model usability, and delivered data analysis insights to stakeholders and product leads, contributing to generative AI training pipelines.",
                projectDesc: "Project Spectra: A data engineering and AI/ML training fellowship at OpenAI (contract work through Handshake) focused on improving image generation models through dataset curation, quality control, and user intent recognition. The work included developing an AI-powered platform with machine learning and predictive analytics, integrating LLM/NLP models for user feedback analysis, automated failure prediction systems, and comprehensive UI/UX optimization. The work involved collaborative research on transfer learning approaches, data versioning protocols, and scalable quality control frameworks for generative AI systems.",
                skills: ["Python", "Machine Learning", "Deep Learning", "Transfer Learning", "Generative AI", "Computer Vision", "Image Generation", "Prompt Engineering", "User Intent Recognition", "Data Engineering", "Dataset Curation", "Metadata Management", "Context-Aware Systems", "Quality Control", "Data Integrity", "Data Quality Assurance", "Data Cleaning", "Data Versioning", "Version Control", "MLOps", "Reproducibility", "ML Experimentation", "Model Validation", "Scalability", "Framework Design", "Troubleshooting", "Debugging", "Data Analysis", "Cross-Team Collaboration", "Conflict Resolution", "Problem Solving", "Critical Thinking", "scikit-learn", "pandas", "Natural Language Processing (NLP)", "Large Language Models (LLM)", "JavaScript", "Frontend Development", "UI/UX Design", "Data Visualization", "User Telemetry", "Predictive Analytics", "Quality Assurance (QA)", "Unit Testing", "Accessibility", "Responsive Design", "Architecture Design", "Performance Optimization", "Algorithm Optimization", "Cross-Functional Collaboration", "Presentation Skills", "User Feedback Analysis", "Usability Testing", "Technical Documentation", "Stakeholder Communication"],
                size: 4.1,
                position: 119,
                texture: './images/mercury.jpg',
                gif: './images/openai_fellowship.gif'
            },
            {
                ...
                skills: ["Neuroscience", "Developmental Psychology", "Electroencephalography (EEG)", "Eye-Tracking", "Data Analysis", "Research Methods", "Infant Research", "Cognitive Neuroscience", "Statistical Analysis", "Signal Processing", "Behavioral Assessment", "Temperament Research", "Attention Bias", "Anxiety Research", "Neuroimaging", "Research Collaboration", "Data Collection", "Scientific Research", "Psychology", "Clinical Research"],
                size: 4.2,
                position: 210,
                texture: './images/venus.jpg',
                gif: './images/bead_lab.gif'
            },
            {
            ...
            {
                name: "Fly Brain Connectome",
                description: "USC Research Lab | 2025",
                year: 2025,
                visitability: "In Progress",
                link: null,
                overview: "As Research Assistant, I am modeling the exact neural connections of a fly's brain in Minecraft to achieve natural agentic behavior, collaborating with PhD advisor and neuroimaging/cognitive science researchers on connectome architecture. I am implementing a computer vision system for visual perception enabling the fly to learn about its surroundings, developing olfactory system stimuli using raycasting for sensory input processing and spatial awareness, and training neural networks using player interactions in Minecraft environment for reinforcement learning. I am designing an agentic behavior framework that learns and adapts based on environmental stimuli and interactions, building a modular sensory system integrating visual, olfactory, and proprioceptive inputs for realistic behavior.",
                projectDesc: "A computational neuroscience research project modeling the fly brain connectome in Minecraft to achieve natural agentic behavior. The project integrates computer vision, reinforcement learning, and multi-sensory systems to create realistic behavioral models based on actual neural architecture.",
                skills: ["Python", "Machine Learning", "Reinforcement Learning", "Neural Networks", "Computational Neuroscience", "Neuroimaging", "Connectome Modeling", "Computer Vision", "Image Processing", "Raycasting", "Sensory Systems", "Olfactory Processing", "Cognitive Science", "Cognitive Modeling", "Minecraft", "Agentic AI", "Behavior Modeling", "Neural Architecture", "Multi-Sensory Integration", "Deep Learning", "Game Engine Development", "3D Simulation", "Spatial Perception", "Machine Learning Training", "Research Collaboration", "Interdisciplinary Research", "Scientific Computing", "Data Analysis", "Model Validation"],
                size: 4.2,
                position: 390,
                texture: './images/earth.jpg',
